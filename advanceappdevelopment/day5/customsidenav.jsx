...
const CustomSideNav = () => {
  ...
  return (
    <div className="custom-sidenav-container">
      ...
      >
        <Sidenav.Body style={{ backgroundColor: '#1d1d1d', color: 'mediumblue' }}>
          <Nav activeKey={activeKey} onSelect={setActiveKey}>
            ...
            <Nav.Menu placement="rightStart" eventKey="3" title="Courses" icon={<MagicIcon />}>
              <Nav.Item eventKey="3-1"><NavLink to={'/postcourse'}>Post </NavLink></Nav.Item>
              <Nav.Item eventKey="3-2"><NavLink to={'/deletecourse'}>Delete </NavLink></Nav.Item>
              <Nav.Item eventKey="3-3"><NavLink to={'/editcourse'}>Edit </NavLink></Nav.Item>
              <Nav.Item eventKey="3-4"><NavLink to={'/view'}>View </NavLink></Nav.Item>
            </Nav.Menu>
